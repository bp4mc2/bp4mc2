...
This document describes the way versioning is implemented in the Catalogus. @@ik zou 2 plaatjes opnemen: 1 hoe de mastergraph en versiongraph samenhangen en hoe de actuele of een eerdere versie van documentatie over een resource wordt opgevraagd en 1 hoe een update gaat@@ @@overigens is deze technische implementatie voor concepten. De technische implementatie voor andere typen resources zoals teksten/plaatjes en modellen is waarschijnlijk anders. Voor de data zelf waarschijnlijk weer hetzelfde, hoewel bij grote datasets ook performance belangrijk gaat worden bij een werkebare oplossing@@ 
