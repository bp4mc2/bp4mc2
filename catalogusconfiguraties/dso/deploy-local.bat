...
powershell -Command "(gc 'Stage DSO local.ttl') -replace 'http://localhost:8080', 'http://data.ontwikkeling.pdok.nl' -replace 'http://localhost:7200', 'http://sou591.so.kadaster.nl:7200' | Out-File -encoding UTF8 'Stage DSO O.ttl'"
