...
cd ..
curl.exe -X POST -T "Stage GCO local.ttl" http://localhost:8890/sparql-graph-crud?graph-uri=http://localhost:8080/gco/stage
curl.exe -X POST -T "Stage GCO local.ttl" http://localhost:8890/sparql-graph-crud?graph-uri=http://localhost:8080/catalogus/stage
